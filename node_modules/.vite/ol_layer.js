...
var CanvasVectorTileLayerRenderer = function(_super) {
  ...
  CanvasVectorTileLayerRenderer2.prototype.updateExecutorGroup_ = function(tile, pixelRatio, projection) {
    ...
    var _loop_1 = function(t4, tt2) {
      ...
      var bufferedExtent = equals2(sourceTileExtent, sharedExtent) ? null : builderExtent;
...
var GeometryCollection = function(_super) {
  __extends8(GeometryCollection2, _super);
  ...
  GeometryCollection2.prototype.rotate = function(angle, anchor2) {
    var geometries = this.geometries_;
    for (var i = 0, ii = geometries.length; i < ii; ++i) {
  ...
  GeometryCollection2.prototype.scale = function(sx, opt_sy, opt_anchor) {
    var anchor2 = opt_anchor;
    if (!anchor2) {
      anchor2 = getCenter(this.getExtent());
    }
    var geometries = this.geometries_;
    for (var i = 0, ii = geometries.length; i < ii; ++i) {
      geometries[i].scale(sx, opt_sy, anchor2);
    }
    this.changed();
  };
...
var JSONFeature = function(_super) {
  __extends9(JSONFeature2, _super);
...
function extend3(output, ...inputs) {
...
var StylePropertyFunction = class {
  constructor(parameters, specification) {
    ...
    extend3(this, createFunction(this._parameters, this._specification));
  }
...
function validateFilter(options) {
  if (isExpressionFilter(deepUnbundle(options.value))) {
    return validateExpression(extend3({}, options, {
    ...
    objectElementValidators: {
      ...
      layout(options2) {
        return validateObject({
          ...
          objectElementValidators: {
            "*"(options3) {
              return validateLayoutProperty(extend3({ layerType: type }, options3));
            }
          }
        });
      },
      paint(options2) {
        return validateObject({
          ...
          objectElementValidators: {
            "*"(options3) {
              return validatePaintProperty(extend3({ layerType: type }, options3));
            }
          }
        });
      }
...
function validate(options) {
  ...
  if (valueSpec.expression && isFunction$1(unbundle(value))) {
    ...
    const valid = validateObject(extend3({}, options, { valueSpec: valueSpec.type ? styleSpec[valueSpec.type] : valueSpec }));
    return valid;
  }
}
...
var ErrorEvent = function(_super) {
  __extends11(ErrorEvent2, _super);
...
var MapboxVectorLayer = function(_super) {
  __extends11(MapboxVectorLayer2, _super);
...
var CanvasVectorImageLayerRenderer = function(_super) {
  __extends12(CanvasVectorImageLayerRenderer2, _super);
...
var VectorImageLayer = function(_super) {
  __extends13(VectorImageLayer2, _super);
...
var TileTexture = function(_super) {
  __extends14(TileTexture2, _super);
...
var WebGLTileLayerRenderer = function(_super) {
  __extends15(WebGLTileLayerRenderer2, _super);
...
var WebGLPointsLayer = function(_super) {
  __extends16(WebGLPointsLayer2, _super);
...
var WebGLTileLayer = function(_super) {
  __extends17(WebGLTileLayer2, _super);
