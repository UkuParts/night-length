...
addDecoder([void 0, 1], () => import("./raw-JO3CNDOX.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-PPQUW35H.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-CI7YV4AU.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-X674KI7L.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-FZAETXPL.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-X3M6UKLS.js").then((m) => m.default));
